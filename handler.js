...
const meetingsTableName = "chime-meetings-dev"; // //process.env.MEETINGS_TABLE_NAME;
const attendeesTableName = "chime-attendees-dev"; //process.env.ATTENDEES_TABLE_NAME;
const sqsQueueArn = "arn:aws:sqs:ap-southeast-1:769625606299:chime-queue"; //process.env.SQS_QUEUE_ARN;
const provideQueueArn = true; //process.env.USE_EVENT_BRIDGE === "false";
const logGroupName = "chime-logs"; // process.env.BROWSER_LOG_GROUP_NAME;
...
exports.createMeeting = async (event, context, callback) => {
  ...
  const region = event.queryStringParameters.region || "ap-southeast-1";
